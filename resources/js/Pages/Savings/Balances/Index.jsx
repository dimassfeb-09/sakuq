    ...
    return (
        <div className="flex w-full flex-col gap-y-6 pb-32">
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-4">
                ...
                <CardStat
                    data={{
                        title: 'Total Tabungan (Saldo Awal + Tabungan)',
                ...
                <CardStat
                    data={{
                        title: 'Realisasi (Tabungan yang di capai tersisa)',
                        icon: IconTimeline,
            ...
            <Alert variant={props.goal.balances_sum_amount >= props.goal.monthly_saving ? 'success' : 'destructive'}>
                <AlertTitle>
                    {props.goal.balances_sum_amount >= props.goal.monthly_saving ? 'Yeaay' : 'Oops'}
                </AlertTitle>
                <AlertDescription>
                    {props.goal.balances_sum_amount >= props.goal.monthly_saving
                        ? 'Anda telah mencapai target bulanan'
                        : 'Anda belum mencapai target bulanan'}
                </AlertDescription>
            </Alert>
